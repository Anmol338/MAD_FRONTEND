            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text("${widget.productModel.title}", style:
                      TextStyles.heading3,),
                    Text("Rs. ${Formatter.formatPrice(widget.productModel.
                    price!)}", style: TextStyles.heading2,),
                    ...
                    Text("${widget.productModel.description}", style:
                      TextStyles.body1,),
                  ],
                ),
              ),
